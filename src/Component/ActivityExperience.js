              ...
              <div className='newactivity-experiencewraper'>
                <div className='newact-exphead'>
                  ...
                  <div className='newact-revsave'>
                    <p className='newactreview'><img src={startIcon} alt='' />&nbsp;<span>4.5</span> (10 reviews)&nbsp;&nbsp;|&nbsp;&nbsp;100+ Booked <span className='verified-business'>Verified Business</span> </p>
